...
class AMPLoader:
    ...
    def __init__(
            ...
            motion_files=glob.glob(glob.escape('/home/ubuntu/amp/AMP_for_hardware-main/datasets/motion_motions/pace0.txt')),
            ):
        ...
        # motion_files = glob.glob(glob.escape('/home/ubuntu/amp/AMP_for_hardware-main/datasets/mocap_motions/pace0.txt'))
        motion_files = os.listdir("/home/ubuntu/ubuntu/xy/amp/AMP_for_hardware-main/datasets/mocap_motions/")
        # print("DEBUG", motion_files)
        for i, motion_file in enumerate(motion_files):
            self.trajectory_names.append(motion_file.split('.')[0])
            motion_file = os.path.join("/home/ubuntu/ubuntu/xy/amp/AMP_for_hardware-main/datasets/mocap_motions/", motion_file)
