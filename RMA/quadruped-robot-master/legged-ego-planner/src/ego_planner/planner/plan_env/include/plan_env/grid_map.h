...
struct MappingParameters
{
  ...
  double surround_clear_x_lb_;
  double surround_clear_x_ub_;
  double surround_clear_y_lb_;
  double surround_clear_y_ub_;
  double cut_z_range_;
  int inf_grid_;
  string frame_id_;
  int pose_type_;
...
private:
  ...
  void cloudOdomCallback(const sensor_msgs::PointCloud2ConstPtr &cloud, const nav_msgs::OdometryConstPtr &odom);
