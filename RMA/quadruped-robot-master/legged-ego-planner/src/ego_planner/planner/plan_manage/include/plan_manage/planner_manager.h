...
namespace ego_planner
{
  ...
  public:
    ...
    void visSamplePoints(vector<Eigen::Vector3d> sample_points);
    std::vector<Eigen::Vector3d> calculateUTurnWaypoints(const Eigen::Vector3d start_pos, const double start_yaw, const Eigen::Vector3d goal);
    ...
    // inline PtsChk_t getPtsCheck(void) { return poly_traj_opt_->get_pts_check_(); }
  ...
  private:
    ...
    ros::Publisher way_point_vis_pub_;
