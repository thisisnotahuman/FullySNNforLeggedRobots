...
namespace ego_planner
{
  ...
  private:
    ...
    std::vector<Eigen::Vector3d> front_waypoints_;
    ...
    ros::Subscriber waypoint_sub_, odom_sub_, trigger_sub_, broadcast_ploytraj_sub_, mandatory_stop_sub_, dog_state_sub_, aim_sub_;
    ros::Publisher poly_traj_pub_, data_disp_pub_, broadcast_ploytraj_pub_, heartbeat_pub_, ground_height_pub_;
    ros::Publisher aim_world_pub_, aim_body_pub_;
